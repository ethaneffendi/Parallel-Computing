...
def computeMandelbrotSet_without_multiprocessing(inputList, maxIterations = 1000, maxModulus = 10 ** 6 + 1):
    # iterate through inputList
    for i in range(len(inputList)):
        # set inputList's value at i to be what color the complex number at i should be in a Mandelbrot set visualization
        inputList[i] = isInMandelbrotSet(inputList[i], maxIterations, maxModulus)
    return inputList
...
inputList = computeMandelbrotSet_without_multiprocessing(inputList)
